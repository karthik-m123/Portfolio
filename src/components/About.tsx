...
import { Shield, Search, Bot, Target, Zap, Brain, Code, Database } from "lucide-react";
    ...
    <section id="about" className="py-20 bg-gray-900 text-white">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-purple-400 via-cyan-400 to-green-400 mx-auto rounded-full" />
        </motion.div>
