...
void main() {
  ...
  useEffect(() => {
    ...
    u.lightSpread.value = isMobile ? lightSpread * 1.8 : lightSpread
    u.rayLength.value = isMobile ? rayLength * 1.2 : rayLength
  ...
  return (
    <>
      <LightRays
        raysOrigin="top-center"
        raysColor="#6366f1"
        lightSpread={isMobile ? 0.8 : 0.6}
        rayLength={isMobile ? 2.2 : 2.8}
        fadeDistance={isMobile ? 1.0 : 1.2}
        pulsating
        raysSpeed={isMobile ? 0.08 : 0.12}
        mouseInfluence={isMobile ? 0.05 : 0.08}
        distortion={isMobile ? 0.002 : 0.005}
        noiseAmount={0}
        saturation={isMobile ? 1.0 : 1.1}
      ...
      <div
        className="absolute inset-0"
        style={{
          background: "linear-gradient(to top, #0F172A 15%, transparent 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          mask: "radial-gradient(circle at center, black 0%, black 60%, transparent 95%)",
          WebkitMask: "radial-gradient(circle at center, black 0%, black 60%, transparent 95%)",
        }}
      />
    </>
  )
