...
export const StardustButton = ({
  ...
  const buttonStyle: React.CSSProperties & { [key: string]: any } = {
    '--white': '#e6f3ff',
    '--bg': '#0a1929',
    '--radius': '100px',
    outline: 'none',
  ...
  const beforeAfterStyles = `
    ...
    .pearl-button .wrap div span:nth-child(2) {
      display: none;
    }
    
    .pearl-button:hover .wrap div span:nth-child(1) {
      display: none;
    }
    
    .pearl-button:hover .wrap div span:nth-child(2) {
