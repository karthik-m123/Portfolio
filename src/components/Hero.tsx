...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="home"
      className="hero-section relative flex min-h-screen flex-col items-center justify-center overflow-hidden pt-20"
    >
      <LampContainer>
        <motion.div
        ...
        >
          <motion.h1
            className="text-5xl font-bold md:text-7xl mb-6"
          ...
          <div className="flex h-16 items-center justify-center text-2xl font-medium md:text-4xl mb-8">
            <span className="mr-3 text-gray-300">I'm an </span>
          ...
          <motion.p
            ...
            className="mx-auto max-w-4xl text-xl leading-relaxed text-gray-300 md:text-2xl mb-12"
          >
            ...
            and{' '}
            <span className="font-semibold text-green-400">Cybersecurity</span>.
