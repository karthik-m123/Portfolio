...
import { Menu, X, Github, Linkedin, Mail, Copy, Check } from 'lucide-react';
      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
            className="text-2xl font-bold bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent cursor-pointer"
              ...
              >
                ...
                {activeSection === item.id && (
                  <motion.div
                    ...
                    className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-green-400 to-blue-400"
                    initial={false}
          ...
          <motion.button
            ...
            className="md:hidden p-2 rounded-lg hover:bg-gray-800/50 transition-colors duration-200 text-gray-300"
          >
            <motion.div
        ...
        >
          <div className="py-4 border-t border-gray-700 mt-4">
            ...
            <motion.div
              ...
              className="flex justify-center space-x-6 mt-6 pt-4 border-t border-gray-700"
            >
              {socialLinks.map(({ Icon, href, label, onClick }) => (
                <motion.a
                  key={label}
                  ...
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="p-3 rounded-full transition-all duration-200 text-gray-400 hover:text-white bg-gray-800/50 hover:bg-gray-700/50 backdrop-blur-sm"
                  aria-label={label}
                >
               ...
               <motion.button
                ...
                aria-label="Copy email"
              >
                {copied ? <Check className="w-6 h-6 text-green-400" /> : <Mail className="w-6 h-6" />}
              </motion.button>
            </motion.div>
          </div>
        </motion.div>
